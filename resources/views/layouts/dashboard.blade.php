    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item {{ isActive('settings', 'menu-open') }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('settings.app') }}" class="nav-link {{ isActive('settings.app') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Application</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('settings.notification') }}" class="nav-link {{ isActive('settings.notification') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Notification</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('settings.email') }}" class="nav-link {{ isActive('settings.email') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Email</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('settings.telegram') }}" class="nav-link {{ isActive('settings.telegram') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Telegram</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('settings.api') }}" class="nav-link {{ isActive('settings.api') }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>API</p>
                </a>
              </li>
